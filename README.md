2026.9.11系统更新23.0.0，熔断数变成24，大气层1.11.2不支持，而且续航、lite和oled的机型真实系统升23.0.0会影响当前虚拟系统22.5.0或以下系统（就是休眠死机bug），等大气层更新适配后产生新的warmboot_mariko才能解决。

大气层1.11.2最高支持NX-22.5.0系统。先更新SD卡上的大气层文件，再解压缩官方离线升级固件文件夹，把文件夹复制到SD卡，进系统，找到相册Daybreak刷离线固件升级包.

21.0.0升级21.0.1是小版本更新，大概率无需升级大气层三件套，主机没有新熔断。

20.0.0升级20.5.0是中版本更新，大概率要升级大气层三件套，主机没有新熔断。
