# 2026.04.07更新switch22.1.0系统，没有新增熔断，还是23，atmosphere1.11.0+hekate6.5.2只能进真实正版系统22.1.0，并不支持进真实和虚拟破解系统22.1.0，接下来可能hekate6.5.2不需要更新，但atmosphere必须要更新了。22.1.0的离线升级固件只是暂时上传。

# 请勿更新22.1.0！

大气层1.11.0最高支持NX-22.0.0系统。先更新SD卡上的大气层文件，再解压缩官方离线升级固件文件夹，把文件夹复制到SD卡，进系统，找到相册Daybreak刷离线固件升级包.

21.0.0升级21.0.1是小版本更新，大概率不需要升级大气层三件套。

20.0.0升级20.5.0是中版本更新，有概率不需要升级大气层三件套，也有概率需要升级。

20.0.0升级21.0.0是大版本更新，大概率要升级大气层三件套，主机大概率有新的熔断。
