# 2025.05.28，Switch更新20.1.0系统，熔断还是21，warmboot_mariko补丁还是wb_15.bin无需增加，大气层1.9.0最高只能支持20.0.1，还未更新无法支持20.1.0系统，目前只能引导进真实(正版)系统20.1.0，真实(破解)系统20.1.0和虚拟系统20.1.0均无法进入，等atmosphere+hekate更新适配20.1.0系统。

大气层1.9.0最高支持NX-20.0.1系统。先更新SD卡上的大气层文件，再解压缩官方离线升级固件文件夹，把文件夹复制到SD卡，进系统，找到相册Daybreak刷离线固件升级包
