2025.5.2，Switch系统更新20.0.1，修复20.0.0的部分bug，据说部分的主机正版更新20.0.0后出现报错进不去系统，所以这些主机只能在开机进正版系统之前出现Nintendo的时候按住音量+-，进入官方的维护模式，在那里联wifi更新系统到20.0.1就消除bug了。同样大气层还在适配中，20.0.1应该是小修复，如果大气层能破20.0.0，也一定能破20.0.1
